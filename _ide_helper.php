 ...
 * Generated for Laravel 5.0.33 on 2015-08-06.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \Grace\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Grace\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Grace\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Grace\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Grace\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Grace\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Grace\Console\Kernel::bootstrap();
        }
    ...
    class Feeder extends \Grace\Feeder\Facade\Feeder{
        ...
        public static function feed($entries, $settings = null){
            return \Grace\Feeder\Feeder::feed($entries, $settings);
        }
        
    }


    class Search extends \Grace\Search\Facade\Search{
        ...
        public static function search($search){
            return \Grace\Search\Search::search($search);
        }
        
    }


    class LogViewer extends \Grace\LogViewer\Facade\LogViewer{
        ...
        public static function getLogs($level = 'all'){
            return \Grace\LogViewer\LogViewer::getLogs($level);
        }
         ...
         * @static 
         */
        public static function deleteLogFile($path){
            return \Grace\LogViewer\LogViewer::deleteLogFile($path);
        }
    ...
    class Lipsum extends \Magyarjeti\LaravelLipsum\LipsumFacade{
         ...
         * @static 
         */
        public static function text($paragraphs = null){
            return \Magyarjeti\Loripsum\Client::text($paragraphs);
        }
