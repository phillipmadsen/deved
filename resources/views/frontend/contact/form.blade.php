            ...
            <div id="page-menu-wrap">
                <div class="container clearfix ">
                    <nav class="one-page-menu">
                        <ul>
                            <li><a class="current" href="{!! url('/' . getLang()) !!}/">Returns</a></li>
                            <li><a href="{!! url('/' . getLang()) !!}/"><div>Privacy</div></a></li>
                            <li><a href="{!! url('/' . getLang()) !!}/"><div>Terms of Service</div></a></li>
                          {{--   <li><a href="{!! url('/' . getLang()) !!}/"><div>FAQs</div></a></li> --}}
