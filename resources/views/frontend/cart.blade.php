						...
						<table class="table cart">
							...
							<tbody>
								...
								<tr class="cart_item">
									...
									<td class="cart-product-thumbnail">
										<a href="#"><img width="64" height="64" src="{!! url('frontend/images/shop/thumbs/small/shoes-2.jpg') !!}" alt="Checked Canvas Shoes"></a>
									</td>
								...
								<tr class="cart_item">
									...
									<td class="cart-product-thumbnail">
										<a href="#"><img width="64" height="64" src="{!! url('frontend/images/shop/thumbs/small/tshirt-2.jpg') !!}" alt="Pink Printed Dress"></a>
									</td>
