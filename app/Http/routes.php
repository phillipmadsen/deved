...
// Route::get('machine-quilting', array('as' => 'dashboard.page.machine', 'uses' => 'PageController@machine'));
    ...
    // page
    //Route::get('/{slug}', array('as' => 'dashboard.pages.{slug}.{slug}', 'uses' => 'PageController@{slug}'));
  //   //Route::get('/{slug}', array('as' => 'dashboard.page.show', 'uses' => 'PageController@show'));
    ...
    Route::get('/faq', array('as' => 'dashboard.faq.show', 'uses' => 'FaqController@show'));
    //Route::get('/faqs', array('as' => 'dashboard.faq', 'uses' => 'FaqController@show'));
    // rss
...
Route::group(array('prefix' => LaravelLocalization::getCurrentLocale()), function () {
    Route::group(array( 'prefix'    => '/shop' ),  function () {
        ...
        Route::get('/', array('as' => 'frontend.shop', 'uses' => 'PageController@shop')); 
        Route::get('/cart', array('as' => 'frontend.cart', 'uses' => 'PageController@cart')); 


    });
});
Route::group(array('prefix' => LaravelLocalization::getCurrentLocale()), function () {
    Route::get('/newuser', array('as' => 'frontend.newuser', 'uses' => 'PageController@newuser')); 
});
Route::group(array('prefix' => LaravelLocalization::getCurrentLocale()), function () {
        Route::group(array( 'prefix'    => '/qnique' ),  function () {
